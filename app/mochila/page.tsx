        ...
        <section className="min-h-[140vh] flex items-center justify-center section-padding relative">
          <div className="container-max">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Link href="/jornada" className="btn-primary text-lg">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-32">
                  ...
                  <button
                    ...
                    className="block w-full py-3 px-6 bg-terra text-areia text-center rounded-lg font-medium hover:bg-folha hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 mb-3"
                  >
